...
func (r *emailRepository) Create(ctx context.Context, email *domain.Email) error {
	...
	query := `
	INSERT INTO emails (id, sender, receiver, subject, body, is_html, html_template_id, sent_at)
	VALUES (:id, :sender, :receiver, :subject, :body, :is_html, :html_template_id, :sent_at)
	`
